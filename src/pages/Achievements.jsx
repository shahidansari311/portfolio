...
const achievementsData = [
  {
    ...
    year: "2026",
    description: "Actively contributed to open-source repositories as part of GSSoC '26, submitting pull requests, fixing issues, and collaborating with maintainers on real-world codebases.",
      ...
      <motion.div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10" variants={containerVariants} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }}>
        {achievementsData.map((achievement, index) => (
          <motion.div key={index} variants={itemVariants}>
            <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.02} transitionSpeed={2500} className="h-full cursor-pointer" glareEnable={true} glareMaxOpacity={0.15} glareColor="#ffffff" glarePosition="all">
